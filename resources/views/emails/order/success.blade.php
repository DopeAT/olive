...
<head>
    ...
    <title>Olive power - Order Confirmation Invoice</title>
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td class="content-block">
                                                    <img src="{{ url('/images/olive_home.svg') }}" width="115px">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="content-block">
                                                            ...
                                                            <td>
                                                                <table class="invoice-items" cellpadding="0" cellspacing="0">
                                                                    ...
                                                                    @foreach(json_decode($order->products) as $product)
                                                                        <tr>
                                                                            <td>{{ $product->name }}</td>
                                                                            <td>x{{ $product->total }}</td>
                                                                            <td>€{{ $product->price }}</td>
                                                                            <td class="alignright">€{{ $product->total * $product->price  }}</td>
                                                                        </tr>
                                                                    @endforeach
                                                                    <tr class="total">
                                                                        <td>Total</td>
